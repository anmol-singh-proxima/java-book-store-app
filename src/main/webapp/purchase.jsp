...
#purchaseItem table th, #purchaseItem table td {
	text-align: left;
	padding: 6px 10px;
	border: 1px solid #787878;
}
...
#actionButton a:nth-child(1) {
	background-color: DodgerBlue;
	border: 1px solid DodgerBlue;
	color: #fff;
}
#actionButton a:nth-child(2) {
...
<body>
	...
	<section id="content">
		...
		<div id="purchaseItem">
			...
			<div id="note">
				<h4>Note:</h4>
				<p>If confirm, Make Transaction<br/>If no, Go Back</p>
			</div>
			<div id="actionButton">
				<a href="./bookDetails?bookId=${book.bookId}" >Go Back</a>
				<a href="./makeTransaction?bookId=${book.bookId}&customerId=${customer.customerId}" >Make Transaction</a>
			</div>
		</div>
